...
abstract class $MiraiFormFieldCopyWith<$Res> {
  ...
  @useResult
  $Res call({Map<String, dynamic>? child, bool isTypeAction});
}
...
class _$_MiraiFormField implements _MiraiFormField {
  const _$_MiraiFormField(
      {final Map<String, dynamic>? child, this.isTypeAction = false})
      : _child = child;
  ...
  @override
  String toString() {
    return 'MiraiFormField(child: $child, isTypeAction: $isTypeAction)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(_child), isTypeAction);
...
abstract class _MiraiFormField implements MiraiFormField {
  const factory _MiraiFormField(
      ...
      final bool isTypeAction}) = _$_MiraiFormField;
